...
#define THICK 1
  ...
  // top
  {
    ...
    MPI_Type_create_subarray
      (2, outsize,subsize,start,   MPI_ORDER_C,MPI_DOUBLE,&topsend);
  }
  // bot
  {
    int subsize[2] = {THICK,N}; int start[2] = {N-THICK,0};
    MPI_Type_create_subarray
      (2, outsize,subsize,start,  MPI_ORDER_C,MPI_DOUBLE,&botsend);
  }
  // left
  {
    int subsize[2] = {N,THICK}; int start[2] = {0,0};
    MPI_Type_create_subarray
      (2, outsize,subsize,start,  MPI_ORDER_C,MPI_DOUBLE,&leftsend);
  }
  // right
  {
    int subsize[2] = {N,THICK}; int start[2] = {0,N-THICK};
    MPI_Type_create_subarray
      (2, outsize,subsize,start,  MPI_ORDER_C,MPI_DOUBLE,&rightsend);
  }
  ...
  // top
  {
    ...
    MPI_Type_create_subarray
      (2, insize,subsize,start,  MPI_ORDER_C,MPI_DOUBLE,&toprecv);
  }
  // bot
  {
    int subsize[2] = {THICK,N}; int start[2] = {N+2-THICK,1};
    MPI_Type_create_subarray
      (2, insize,subsize,start,  MPI_ORDER_C,MPI_DOUBLE,&botrecv);
  }
  // left
  {
    int subsize[2] = {N,THICK}; int start[2] = {1,0};
    MPI_Type_create_subarray
      (2, insize,subsize,start,  MPI_ORDER_C,MPI_DOUBLE,&leftrecv);
  }
  // right
  {
    int subsize[2] = {N,THICK}; int start[2] = {1,N+2-THICK};
    MPI_Type_create_subarray
      (2, insize,subsize,start,  MPI_ORDER_C,MPI_DOUBLE,&rightrecv);
  }
  }
