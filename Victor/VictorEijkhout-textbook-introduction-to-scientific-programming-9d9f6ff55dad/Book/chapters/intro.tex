...
\begin{block}{Hands-on programming}
  ...
  \includegraphics[scale=.5]{eniac-programming}
\end{block}

\begin{block}{Program entry}
  \label{sl:punch}
  Later programs were written on punchcards\\
  \includegraphics[scale=.2]{punchcards}
\end{block}
...
\begin{block}{Programming is not simple}
  \label{sl:hamilton}
  Programs can get pretty big:

  \begin{multicols}{2}
    \includegraphics[scale=.12]{hamilton}
    \vfill\columnbreak
    \small\sl
    ...
    flight software for the Apollo space program.
  \end{multicols}
