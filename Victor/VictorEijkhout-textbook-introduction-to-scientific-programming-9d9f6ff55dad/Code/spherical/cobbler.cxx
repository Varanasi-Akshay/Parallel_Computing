...
int main() {
  ...
  cout << "The customer pays " << cost_per_repair << " per repair" << endl;
  ...
  cout << "The economy can sustain " << ncobblers << " cobblers" << endl;
  
  // How many new cobblers per year?
  int working_years = 40;
  int new_cobblers_per_year = ncobblers / working_years;
  cout << "We need " << new_cobblers_per_year << " new cobblers per year" << endl;
