  ...
  subroutine attach( the_list,value )
    ...
    if (.not.associated(the_list%head)) then
       ...
       if (current%value==value) then
          ...
          !print *,"Make new node before",current%value
          !!codesnippet listinsertf
          allocate(new_node)
          new_node%value = value
          ...
          !print *,"Make new node to append after",current%value
          !!codesnippet listattachf
          allocate(new_node)
          new_node%value = value
          nullify(new_node%next)
