...
\begin{abstract}
  ...
  of this package. 
  For reasons of compatibility with certain operating systems, the
...
use the package \texttt{fix2col}\footnote{Get the package from the CTAN
  sites in \texttt{tex-archive/macros/latex/contrib/supported/carlisle/}.},
this will be solved\footnote{The \texttt{multicol} package uses a similar
  technique.}.
%%
%%\begin{figure}[tb]
%%\small
